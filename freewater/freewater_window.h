#ifndef FREEWATER_WINDOW_H
#define FREEWATER_WINDOW_H
#include <QMessageBox>
#include <QMainWindow>
...
namespace Ui {
    class freewater_window;
}

struct src_data;
class freewater_window : public QMainWindow
{
    Q_OBJECT
    QSettings settings;
public:
    ...
    explicit freewater_window(QStringList filenames_,QWidget *parent = nullptr);
    ~freewater_window();
